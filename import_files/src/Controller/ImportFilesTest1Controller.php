...
/**
 * Tests CSV and FW files without headers, and overriding filename for type name,
 * 11/1/2017 verified no errors/issues after adding taxonomy term functionality
 */
class ImportFilesTest1Controller extends ImportFilesController{
  ...
  {
    $this->set_directory_path("files-test/test1");
  ...
  public function set_file_params()
  {
    $this->file_specs = array(
      "FixedWidthExample2NoHeader.txt" 	=> array(
      ...
      "SalesJan2009NoHeader.csv" 	=> array(
        "path" => "", //dynamically set by reading files
        "column_count" => -1, //dynamically set by reading files
