...
/**
 * Tests CSV and FW files with headers, and type from column and override not set, min fields test,
 * 11/1/2017 verified no errors/issues
 */
class ImportFilesTest4Controller extends ImportFilesController{
    ...
    $this->file_specs = array(
      "FixedWidthExample2.txt" 	=> array(
        ...
        "min_fields"	=> array( //skip line or include
          ...
          "data" => 4, // for min_fields for setting data rows, null or not set is all kv's req
        ),
