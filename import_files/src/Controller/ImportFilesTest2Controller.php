...
/**
 * Tests CSV and FW files with headers, and type from column specified values,
 * 11/1/2017 verified no errors/issues after adding taxonomy term functionality
 */
class ImportFilesTest2Controller extends ImportFilesController{
  ...
  {
    $this->set_directory_path("files-test/test2");
